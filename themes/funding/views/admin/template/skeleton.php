...
<p id="footer-copyright" class="col-xs-12">
   ...
   <script src="<?=App::Assets()->getAsset("admin/js/jquery.knob.js")?>"></script>
   <script src="<?=App::Assets()->getAsset("admin/js/raphael-min.js")?>"></script>
   <script src="<?=App::Assets()->getAsset("admin/js/morris.js")?>"></script>
