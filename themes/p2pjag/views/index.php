...
<div id="wrapper" class="home-page">
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=App::route("")?>"><img src="<?=  App::Assets()->getAsset("newhack")?>/img/logo.png" alt="<?=App::getConfig("site_name")?>"/></a>
                </div>
        ...
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              ...
              <li>
                ...
                <div class="flex-caption">
                    <h3>Get 200% as Fast as possible</h3> 
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="aligncenter"><h1 class="aligncenter">Welcome To Bettar life </h1>A very fast and reliable peer to peer site. We pay 200% of your initial investment. We are available for you with 24/7 support system. Earn big from referring your love ones into the system and make huge profit through the process </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="copyright">
						<p>
							<span>&copy; Bettarlife 2018 All right reserved. 
						</p>
					</div>
				</div>
				<div class="col-lg-6">
