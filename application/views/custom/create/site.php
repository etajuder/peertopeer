					...
					<div class="row">
						<div class="col-xs-12">
							<div id="login-box-inner">
								...
								<div id="login-logo">
									Create your custom tutorial website
								</div>
								
                                                            <form role="form"  name="myform" id="myform" method="post" action="<?=  App::route('install', 'finalize')?>">
                                                                         <?=@$this->session->flashdata('item')?>
									<div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-keyboard-o"></i></span>
                                                                                <input class="form-control" name="stname" type="text" placeholder="Site name">
									</div>
                                                                        <div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-keyboard-o"></i></span>
                                                                                <input class="form-control" name="desc" type="text" placeholder="Site Description">
									</div>
                                                                        <div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                                                                <input type="text" name="name" class="form-control" placeholder="Admin Full name">
									</div>
									<div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                                                                <input type="text" name="user" class="form-control" placeholder="Admin Username">
									</div>
                                                                
                                                                        <div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-key"></i></span>
                                                                                <input class="form-control" name="pass" type="text" placeholder="Admin password">
									</div>
									<div class="row">
										<div class="col-sm-6 col-xs-12 col-sm-push-6">
											<button type="submit" class="btn btn-success col-xs-12">Finish</button>
										</div>
