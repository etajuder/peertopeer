							...
							<div id="login-box-inner">
								...
								<div id="login-logo">
									Create Your Custom Tutorial Website
                                                            ...
                                                            <form role="form"  name="myform" id="myform" method="post" action="<?=  App::route('install', 'installdb')?>">
                                                                         <?=@$this->session->flashdata('item')?>
									<div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                                                                <input class="form-control" name="host" type="text" placeholder="Host" value="localhost">
									</div>
                                                                        <div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
									...
									<div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-key"></i></span>
                                                                        ...
                                                                        <div class="input-group input-group-lg">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                                                                <input class="form-control" name="db" type="text" placeholder="Database">
									</div>
									<div class="row">
										<div class="col-sm-6 col-xs-12 col-sm-push-6">
											<button type="submit" class="btn btn-success col-xs-12">Next</button>
										</div>
